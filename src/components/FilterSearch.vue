<template>
  <q-toolbar
    class="border-4 border-black bg-white h-[75px] px-6 min-w-[400px] max-w-[1800px] justify-center sm:justify-start m-auto"
    style="border-bottom: 1px solid #e9e9e9"
  >
    <q-btn-toggle
      v-model="type"
      class="my-custom-toggle border-solid border-1 border-black mr-[10px]"
      no-caps
      rounded
      unelevated
    ...
    <q-dialog v-model="prompt" persistent>
      ...
      <q-input
        ...
        color="customteal"
        label="Min Price"
        class="rounded absolute top-15% left-13%"
      ></q-input>
      <q-input
        v-model="maxPrice"
        type="number"
        ...
        color="customteal"
        label="Max Price"
        class="rounded absolute top-15% left-24%"
      ></q-input>
      ...
      <q-input
        ...
        color="customteal"
        label="Bedrooms"
        class="rounded absolute top-60% left-35%"
      ></q-input>
      <q-input
        v-model="bathrooms"
        type="number"
        ...
        color="customteal"
        label="Bathrooms"
        class="rounded absolute top-60% left-65%"
      ></q-input>
      ...
      <q-select
        ...
        multiple
        color="customteal"
        class="rounded absolute top-75% left-35% right-35%"
      >
...
const type = ref('buy'); // Type
const location = ref(null); // Location
